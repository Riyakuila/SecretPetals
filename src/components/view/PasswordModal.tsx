...
export default function PasswordModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={toggleOpenPasswordModal}>
      <DialogContent className="sm:max-w-md shadow-2xl rounded-3xl bg-black/50 overflow-hidden border border-zinc-700/50">
        ...
        <div className="relative z-10 p-6">
          <DialogHeader className="text-center pb-6 pt-2">
            <div className="mx-auto mb-6 relative w-fit">
              <div className="p-4 bg-gradient-to-br from-amber-200 via-amber-400 to-amber-600 rounded-2xl shadow-lg relative overflow-hidden">
                <Lock className="w-7 h-7 text-black z-10 relative" />
                <div className="absolute inset-0 rounded-2xl blur-md animate-pulse" />
              </div>
            </div>

            <DialogTitle className="text-xl font-semibold text-amber-300 mb-2">
          ...
          <div className="space-y-6">
            <div className="relative group">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`pr-12 h-12 rounded-xl border-2 font-medium backdrop-blur-sm text-base transition-all duration-300 focus:ring-2 focus:outline-none placeholder:text-zinc-500 ${
                    error
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-4 text-zinc-400 hover:text-amber-400 transition-colors duration-200"
                  disabled={isLoading}
                >
                  {show ? (
            ...
            <div className="flex gap-4 pt-2">
              ...
              <Button
                ...
                className="flex-1 h-11 rounded-xl bg-gradient-to-r from-amber-200 via-amber-400 to-amber-600 text-black hover:from-orange-200 hover:via-orange-400 hover:to-orange-600 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
