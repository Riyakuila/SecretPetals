...
export default function Header({
  ...
  return (
    <div className="py-4 sm:px-6 sm:py-6 md:px-8 md:py-8 text-amber-300 relative overflow-hidden">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="p-2 sm:p-3 bg-transparent rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/20 shadow-lg">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-1 flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2">
              ...
              {loadingState === "success" && (
                <div className="flex items-center gap-1 px-2 py-1 bg-white/20 rounded-full text-xs">
                  ...
                  <span className="xs:inline text-green-400">Protected</span>
                </div>
              )}
            </h2>
