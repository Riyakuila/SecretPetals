...
export default function ViewPage({ messageId }: { messageId: string }) {
  ...
  return (
    <div className="min-h-screen bg-black/50 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-2 sm:p-4 md:p-6 relative overflow-hidden">
      <video
        src="/bgVd.mp4"
        autoPlay
        loop
      ...
      <Card className="w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl min-h-[60vh] sm:min-h-[70vh] bg-black/50 backdrop-blur-xl shadow-2xl border-0 rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden relative z-10">
