...
export default function QRCodeSection({ link }: { link: string }) {
  ...
  return (
    <Card className="rounded-lg sm:rounded-xl md:rounded-2xl border border-[#333] bg-black/50 text-neutral-200 shadow-md">
      <CardHeader className="text-center pb-2 sm:pb-3 md:pb-4 px-3 sm:px-4 md:px-6">
        <CardTitle className="text-xs sm:text-sm md:text-base font-medium text-amber-400">
