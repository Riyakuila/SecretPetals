...
export default function SendPage() {
  ...
  return (
    <div className="min-h-screen bg-black/[0.96] text-[--text-primary] flex items-center justify-center p-6 relative overflow-hidden font-inter">
      ...
      <Card className="w-full max-w-4xl glass-strong rounded-3xl border-none shadow-[--shadow-md] relative z-10 bg-black/50">
        <CardContent className="p-0">
          <div className="bg-gradient-primary px-8 py-8 text-amber-300 relative overflow-hidden rounded-t-3xl">
            <div className="absolute inset-0 backdrop-blur-sm"></div>
            <div className="flex items-center gap-4 relative z-10">
              <div className="p-3 rounded-2xl backdrop-blur-sm border border-white/20 shadow">
                <Send className="w-6 h-6 text-amber-500" />
              </div>
              <div>
                <CardTitle className="text-2xl font-bold mb-1 flex items-center gap-2">
                  Create Secure Message
                  <span className="flex items-center gap-1 px-2 py-1 bg-blue-100 dark:bg-blue-900/20 rounded-full text-xs text-green-400">
                    <Shield className="w-3 h-3 text-green-400" />
                    Protected
                  </span>
                </CardTitle>
                <CardDescription className="text-sm opacity-90 text-gray-300">
          ...
          <div className="p-8 space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex items-center gap-1 px-2 py-1 bg-blue-100 dark:bg-blue-900/20 rounded-full text-xs text-green-400">
