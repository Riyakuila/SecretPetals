...
export default function LinkGenerator() {
  ...
  const generateLink = useCallback(async () => {
    ...
    try {
      ...
      setLink(`${window.location.origin}/view/${response.data.id}`);
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6 px-4 sm:px-0">
      <div>
        <Button
          className="w-full h-12 sm:h-14 bg-gradient-to-r from-amber-300 to-amber-500 hover:from-amber-300 hover:to-amber-600 text-black font-semibold text-base sm:text-lg rounded-xl border border-[#333]  transition-all duration-200"
      ...
      {link && (
        <div className="bg-black/50 rounded-xl p-4 sm:p-6 text-neutral-200 shadow-lg space-y-3 sm:space-y-4">
          ...
          <div className="bg-black/50 rounded-xl p-3 sm:p-4">
            <div className="flex items-center gap-2 mb-2 sm:mb-3 flex-wrap">
              ...
              <div className="flex items-center gap-1 px-2 py-0.5 bg-black/50 rounded-full text-xs text-green-500 border border-green-700">
                <Shield className="w-3 h-3" />
                <span className="xs:inline">Encrypted</span>
              </div>
            </div>

            <div className="flex items-center gap-2 p-2 sm:p-3 bg-black/50 rounded-lg border border-[#333]">
              <input
                type="text"
              ...
              <button
                ...
                className="p-1.5 sm:p-2 text-amber-500 hover:text-green-400 transition-colors duration-200 rounded-lg hover:bg-[#1e1e1e] flex-shrink-0"
                title="Copy link"
              >
                {isCopied ? (
