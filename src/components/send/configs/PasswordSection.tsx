...
export default function PasswordSection() {
  ...
  return (
    <div className="space-y-4 p-3 sm:p-4 rounded-xl border border-[#404040] bg-black/50 transition-all duration-300">
        ...
        <>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-start sm:items-center gap-2 text-xs text-neutral-500">
              <Shield className="w-3 h-3 shrink-0 mt-0.5 sm:mt-0 text-amber-500" />
