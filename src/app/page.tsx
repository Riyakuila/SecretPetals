    ...
    <main className="min-h-screen relative flex flex-col items-center justify-center bg-black/[0.96] antialiased px-4 sm:px-6 lg:px-8 py-8 sm:py-12 overflow-hidden">
      ...
      <section className="text-center max-w-4xl space-y-6 sm:space-y-8 z-10 relative">
        ...
        <div className="relative">
          <div className="absolute inset-x-10 sm:inset-x-20 top-0 bg-gradient-to-r from-transparent via-orange-600 to-transparent h-[2px] w-3/4 blur-sm" />
          <div className="absolute inset-x-10 sm:inset-x-20 top-0 bg-gradient-to-r from-transparent via-orange-600 to-transparent h-px w-3/4" />
          <div className="absolute inset-x-20 sm:inset-x-60 top-0 bg-gradient-to-r from-transparent via-amber-300 to-transparent h-[5px] w-1/4 blur-sm" />
          <div className="absolute inset-x-20 sm:inset-x-60 top-0 bg-gradient-to-r from-transparent via-amber-300 to-transparent h-px w-1/4" />
        </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-amber-100 bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
            SecretPetals
          </h1>
        </motion.div>

        <TextGenerateEffect
          words="Send whispers wrapped in petals — encrypted messages that gently fade after being read. No accounts. No tracking. Just secrets in bloom.🌻"
        ...
        >
          ...
          >
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-neutral-700 text-amber-200 hover:bg-neutral-800 hover:text-amber-300 font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 flex items-center justify-center gap-2"
            >
      ...
      <section className="mt-16 sm:mt-20 md:mt-24 w-full max-w-6xl z-10 relative px-4 sm:px-0">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-orange-100 mb-8 sm:mb-12 bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-400">
      ...
      <motion.footer
        className="mt-16 sm:mt-20 md:mt-24 text-xs sm:text-sm text-gray-300 text-center space-y-2 z-10 relative px-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.6 }}
      >
        <p>Made with 💛 in privacy. No logs. No metadata.</p>
        <p>
          <Link
            href={REPO_LINK}
            target="_blank"
